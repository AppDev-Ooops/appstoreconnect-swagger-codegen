...
open class AppCustomProductPageLocalizationsAPI {
     ...
     */
    public enum FilterPreviewType_appCustomProductPageLocalizationsAppPreviewSetsGetToManyRelated: String { 
     ...
     */
    public enum FieldsAppCustomProductPageLocalizations_appCustomProductPageLocalizationsAppPreviewSetsGetToManyRelated: String { 
     ...
     */
    public enum FieldsAppStoreVersionExperimentTreatmentLocalizations_appCustomProductPageLocalizationsAppPreviewSetsGetToManyRelated: String { 
        case apppreviewsets = "appPreviewSets"
        case appscreenshotsets = "appScreenshotSets"
     ...
     */
    public enum FieldsAppPreviews_appCustomProductPageLocalizationsAppPreviewSetsGetToManyRelated: String { 
     ...
     */
    public enum FieldsAppPreviewSets_appCustomProductPageLocalizationsAppPreviewSetsGetToManyRelated: String { 
     ...
     */
    public enum FieldsAppStoreVersionLocalizations_appCustomProductPageLocalizationsAppPreviewSetsGetToManyRelated: String { 
        case apppreviewsets = "appPreviewSets"
        case appscreenshotsets = "appScreenshotSets"
     ...
     */
    public enum Include_appCustomProductPageLocalizationsAppPreviewSetsGetToManyRelated: String { 
        case appcustomproductpagelocalization = "appCustomProductPageLocalization"
        case apppreviews = "appPreviews"
        case appstoreversionexperimenttreatmentlocalization = "appStoreVersionExperimentTreatmentLocalization"
        case appstoreversionlocalization = "appStoreVersionLocalization"
  ...
  "included" : [ "", "" ]
    ...
    open class func appCustomProductPageLocalizationsAppPreviewSetsGetToManyRelatedWithRequestBuilder(_id: String, filterPreviewType: [String]? = nil, filterAppStoreVersionExperimentTreatmentLocalization: [String]? = nil, filterAppStoreVersionLocalization: [String]? = nil, fieldsAppCustomProductPageLocalizations: [String]? = nil, fieldsAppStoreVersionExperimentTreatmentLocalizations: [String]? = nil, fieldsAppPreviews: [String]? = nil, fieldsAppPreviewSets: [String]? = nil, fieldsAppStoreVersionLocalizations: [String]? = nil, limit: Int? = nil, limitAppPreviews: Int? = nil, include: [String]? = nil) -> RequestBuilder<AppPreviewSetsResponse> {
        var path = "/v1/appCustomProductPageLocalizations/{id}/appPreviewSets"
     ...
     */
    public enum FilterScreenshotDisplayType_appCustomProductPageLocalizationsAppScreenshotSetsGetToManyRelated: String { 
     ...
     */
    public enum FieldsAppScreenshotSets_appCustomProductPageLocalizationsAppScreenshotSetsGetToManyRelated: String { 
        case appcustomproductpagelocalization = "appCustomProductPageLocalization"
     ...
     * enum for parameter fieldsAppCustomProductPageLocalizations
     */
    public enum FieldsAppCustomProductPageLocalizations_appCustomProductPageLocalizationsAppScreenshotSetsGetToManyRelated: String { 
        case appcustomproductpageversion = "appCustomProductPageVersion"
        case apppreviewsets = "appPreviewSets"
        case appscreenshotsets = "appScreenshotSets"
        case locale = "locale"
     ...
     * enum for parameter fieldsAppStoreVersionExperimentTreatmentLocalizations
     */
    public enum FieldsAppStoreVersionExperimentTreatmentLocalizations_appCustomProductPageLocalizationsAppScreenshotSetsGetToManyRelated: String { 
        case apppreviewsets = "appPreviewSets"
        case appscreenshotsets = "appScreenshotSets"
        case appstoreversionexperimenttreatment = "appStoreVersionExperimentTreatment"
        case locale = "locale"
     ...
     */
    public enum FieldsAppScreenshots_appCustomProductPageLocalizationsAppScreenshotSetsGetToManyRelated: String { 
     ...
     * enum for parameter fieldsAppStoreVersionLocalizations
     */
    public enum FieldsAppStoreVersionLocalizations_appCustomProductPageLocalizationsAppScreenshotSetsGetToManyRelated: String { 
        case apppreviewsets = "appPreviewSets"
        case appscreenshotsets = "appScreenshotSets"
        case appstoreversion = "appStoreVersion"
        case _description = "description"
     ...
     * enum for parameter include
     */
    public enum Include_appCustomProductPageLocalizationsAppScreenshotSetsGetToManyRelated: String { 
        case appcustomproductpagelocalization = "appCustomProductPageLocalization"
        case appscreenshots = "appScreenshots"
        case appstoreversionexperimenttreatmentlocalization = "appStoreVersionExperimentTreatmentLocalization"
        case appstoreversionlocalization = "appStoreVersionLocalization"
  ...
  "included" : [ "", "" ]
    ...
    open class func appCustomProductPageLocalizationsAppScreenshotSetsGetToManyRelatedWithRequestBuilder(_id: String, filterScreenshotDisplayType: [String]? = nil, filterAppStoreVersionExperimentTreatmentLocalization: [String]? = nil, filterAppStoreVersionLocalization: [String]? = nil, fieldsAppScreenshotSets: [String]? = nil, fieldsAppCustomProductPageLocalizations: [String]? = nil, fieldsAppStoreVersionExperimentTreatmentLocalizations: [String]? = nil, fieldsAppScreenshots: [String]? = nil, fieldsAppStoreVersionLocalizations: [String]? = nil, limit: Int? = nil, limitAppScreenshots: Int? = nil, include: [String]? = nil) -> RequestBuilder<AppScreenshotSetsResponse> {
        var path = "/v1/appCustomProductPageLocalizations/{id}/appScreenshotSets"
        let _idPreEscape = "\(_id)"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter body: (body) AppCustomProductPageLocalization representation 
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func appCustomProductPageLocalizationsCreateInstance(body: AppCustomProductPageLocalizationCreateRequest, completion: @escaping ((_ data: AppCustomProductPageLocalizationResponse?,_ error: Error?) -> Void)) {
        appCustomProductPageLocalizationsCreateInstanceWithRequestBuilder(body: body).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "included" : [ "", "" ]
     ...
     */
    open class func appCustomProductPageLocalizationsCreateInstanceWithRequestBuilder(body: AppCustomProductPageLocalizationCreateRequest) -> RequestBuilder<AppCustomProductPageLocalizationResponse> {
        let path = "/v1/appCustomProductPageLocalizations"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = JSONEncodingHelper.encodingParameters(forEncodableObject: body)
        let url = URLComponents(string: URLString)


        let requestBuilder: RequestBuilder<AppCustomProductPageLocalizationResponse>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func appCustomProductPageLocalizationsDeleteInstance(_id: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        appCustomProductPageLocalizationsDeleteInstanceWithRequestBuilder(_id: _id).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
     ...
     */
    open class func appCustomProductPageLocalizationsDeleteInstanceWithRequestBuilder(_id: String) -> RequestBuilder<Void> {
        var path = "/v1/appCustomProductPageLocalizations/{id}"
        let _idPreEscape = "\(_id)"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
        let URLString = SwaggerClientAPI.basePath + path
     ...
     * enum for parameter fieldsAppCustomProductPageLocalizations
     */
    public enum FieldsAppCustomProductPageLocalizations_appCustomProductPageLocalizationsGetInstance: String { 
        case appcustomproductpageversion = "appCustomProductPageVersion"
        case apppreviewsets = "appPreviewSets"
        case appscreenshotsets = "appScreenshotSets"
        case locale = "locale"
     ...
     * enum for parameter include
     */
    public enum Include_appCustomProductPageLocalizationsGetInstance: String { 
        case appcustomproductpageversion = "appCustomProductPageVersion"
        case apppreviewsets = "appPreviewSets"
        case appscreenshotsets = "appScreenshotSets"
    }
     ...
     * enum for parameter fieldsAppScreenshotSets
     */
    public enum FieldsAppScreenshotSets_appCustomProductPageLocalizationsGetInstance: String { 
        case appcustomproductpagelocalization = "appCustomProductPageLocalization"
        case appscreenshots = "appScreenshots"
        case appstoreversionexperimenttreatmentlocalization = "appStoreVersionExperimentTreatmentLocalization"
        case appstoreversionlocalization = "appStoreVersionLocalization"
     ...
     * enum for parameter fieldsAppPreviewSets
     */
    public enum FieldsAppPreviewSets_appCustomProductPageLocalizationsGetInstance: String { 
        case appcustomproductpagelocalization = "appCustomProductPageLocalization"
        case apppreviews = "appPreviews"
        case appstoreversionexperimenttreatmentlocalization = "appStoreVersionExperimentTreatmentLocalization"
        case appstoreversionlocalization = "appStoreVersionLocalization"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func appCustomProductPageLocalizationsGetInstance(_id: String, fieldsAppCustomProductPageLocalizations: [String]? = nil, include: [String]? = nil, fieldsAppScreenshotSets: [String]? = nil, fieldsAppPreviewSets: [String]? = nil, limitAppPreviewSets: Int? = nil, limitAppScreenshotSets: Int? = nil, completion: @escaping ((_ data: AppCustomProductPageLocalizationResponse?,_ error: Error?) -> Void)) {
        appCustomProductPageLocalizationsGetInstanceWithRequestBuilder(_id: _id, fieldsAppCustomProductPageLocalizations: fieldsAppCustomProductPageLocalizations, include: include, fieldsAppScreenshotSets: fieldsAppScreenshotSets, fieldsAppPreviewSets: fieldsAppPreviewSets, limitAppPreviewSets: limitAppPreviewSets, limitAppScreenshotSets: limitAppScreenshotSets).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "included" : [ "", "" ]
     ...
     - returns: RequestBuilder<AppCustomProductPageLocalizationResponse> 
     */
    open class func appCustomProductPageLocalizationsGetInstanceWithRequestBuilder(_id: String, fieldsAppCustomProductPageLocalizations: [String]? = nil, include: [String]? = nil, fieldsAppScreenshotSets: [String]? = nil, fieldsAppPreviewSets: [String]? = nil, limitAppPreviewSets: Int? = nil, limitAppScreenshotSets: Int? = nil) -> RequestBuilder<AppCustomProductPageLocalizationResponse> {
        var path = "/v1/appCustomProductPageLocalizations/{id}"
        let _idPreEscape = "\(_id)"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func appCustomProductPageLocalizationsUpdateInstance(body: AppCustomProductPageLocalizationUpdateRequest, _id: String, completion: @escaping ((_ data: AppCustomProductPageLocalizationResponse?,_ error: Error?) -> Void)) {
        appCustomProductPageLocalizationsUpdateInstanceWithRequestBuilder(body: body, _id: _id).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "included" : [ "", "" ]
     ...
     - returns: RequestBuilder<AppCustomProductPageLocalizationResponse> 
     */
    open class func appCustomProductPageLocalizationsUpdateInstanceWithRequestBuilder(body: AppCustomProductPageLocalizationUpdateRequest, _id: String) -> RequestBuilder<AppCustomProductPageLocalizationResponse> {
        var path = "/v1/appCustomProductPageLocalizations/{id}"
        let _idPreEscape = "\(_id)"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{id}", with: _idPostEscape, options: .literal, range: nil)
