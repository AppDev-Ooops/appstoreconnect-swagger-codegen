...
public struct AppEventCreateRequestDataAttributes: Codable {
    ...
    public init(referenceName: String, badge: Badge? = nil, deepLink: String? = nil, purchaseRequirement: PurchaseRequirement? = nil, primaryLocale: String? = nil, priority: Priority? = nil, purpose: Purpose? = nil, territorySchedules: [AppEventAttributesTerritorySchedules]? = nil) {
