...
public struct SubscriptionOfferCode: Codable {
    ...
    public init(type: ModelType, _id: String, attributes: SubscriptionOfferCodeAttributes? = nil, relationships: SubscriptionOfferCodeRelationships? = nil, links: ResourceLinks) {
        self.type = type
        self._id = _id
